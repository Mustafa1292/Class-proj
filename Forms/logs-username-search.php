...
<body>
  ...
  >
    ...
    <button class="btn btn-warning" style="margin: 5px"><a href="./logs-username-search.php"> Search by Username </a></button>
    <form method="post">
      <label for="username" class="input"></label>
        ...
        <input type= "submit" name = search style="margin: 5px; width: 100px;">
    </form>
    </div>
...
<table class="table">
  ...
  <tbody>
    ...
    if(isset($_POST['search'])){
        $u_name = $_POST['Username']; //username inputs
        $sql = "SELECT * FROM logs WHERE user_Uname = '$u_name'";
