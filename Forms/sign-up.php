   ...
   //include 'config/db.php';
    ...
    if(isset($_POST['submit'])){ 
        ...
        if(mysqli_num_rows($res_u) > 0){
            ...
            $query = "INSERT INTO users (firstName, lastName, address, userName, emailUsers, pwdUsers) 
                VALUES('$firstName', '$lastName', '$address', '$userName', '$emailUsers','" . md5($pwdUsers) . "')";
...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST">
      ...
      <br />
      <div>
        <button type="submit" name="submit" class="btn btn-primary" style="margin-left:40%"> Submit </button>
      </div>
    </form>
  </body>
</html>