...
<div>
  ...
  <?php
  //GRAB PARCEL STATUS IF in process.
 ...
 //---------------
  ...
  //NOTE ONLY IF status != completed.
  if($result){
    $sql5 = "SELECT from parcel WHERE status='In progress'";
    ...
    //$sql2 = "SELECT * FROM parcel WHERE receiver= 'In progress'";
