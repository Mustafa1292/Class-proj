<?php
echo 'correctly logged in as an employee!';
?>

<?php
include 'connnect.php';
$uname=$_SESSION['uname'];
$sqll = "Select officeLoc from `users` where emailUsers='$uname'";

$resultt = mysqli_query($con, $sqll);

if($resultt){
    $roww=mysqli_fetch_assoc($resultt);
    $_SESSION['loc']=$roww['officeLoc'];
}
?>
        ...
        <div class="navItem">
          <!-- <a href="../index.html"> -->
            ...
            <h1><span style="font-size: 20px; letter-spacing: 5px"
                ><em> Employee Dashboard for <?php echo $_SESSION['loc'] ?> Location</em></h1>
          <!-- </a> -->
        </div>
      </div>
    </nav>
...
<table class="table">
<h3 style="color:black"> Incoming Packages For <?php echo $_SESSION['loc'] ?> Location</h3>
  <thead>
    <tr>
  ...
  $sql="Select * from `parcel` where office='$officeLoc'";
