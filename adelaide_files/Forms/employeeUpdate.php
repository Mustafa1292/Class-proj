...
if (isset($_POST['submit'])) {
    ...
    $sql = "update users set id=$id,firstName='$fname',lastName='$lname',address='$address',userName='$username',emailUsers='$email',pwdUsers='$password',isAdmin='$admin',isEmployee='$employee', officeLoc='$office' where id=$id";
    ...
    <div class="container">
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $_SESSION['admin'] ?>" class="form-control" placeholder="change to 1 to make an admin, change to 0 to remove status" name="isAdmin">
            </div>
            <div class="form-group">
            ...
            <div>
                ...
                <select name="officeLoc" value="<?php echo $_SESSION['officeLoc'] ?>" id="officeLoc">
            ...
            <button type="submit" class="btn btn-primary" name="leave">Return to users</button>
        </form>
